    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="flex items-center justify-between px-6 py-4 bg-white border-b">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <Link
            href="/shop/male/casual-shoes"
            className="text-gray-900 font-medium hover:text-orange-500"
          >
            MEN
          </Link>
          <Link
            href="/shop/female/casual-shoes"
            className="text-gray-900 font-medium hover:text-orange-500"
          >
            WOMEN
          </Link>
          <Link
            href="/shop/kids/school-shoes"
            className="text-gray-900 font-medium hover:text-orange-500"
          >
            KIDS
          </Link>
            ...
            <div className="relative">
              <div className="text-center">
                <div className="border-4 border-white rounded-lg p-12 inline-block">
                  ...
                  <div className="text-2xl font-bold mt-4 tracking-wider">
                    OFF*
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {saleProducts.map((product) => (
              <Link
                href={`/shop/male/casual-shoes/${product.id}`}
                key={product.id}
              >
                <div
                  key={product.id}
      ...
      <section className="py-16 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-300 mb-8">
            Be the first to know about new arrivals, exclusive offers, and sale
            events
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-400 text-sm">
                Discover the latest trends in footwear. Quality shoes for every
                occasion.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li>
                  <Link href="/shop/male" className="hover:text-white">
                    Men's Shoes
                  </Link>
                </li>
                <li>
                  <Link href="/shop/female" className="hover:text-white">
                    Women's Shoes
                  </Link>
                </li>
                <li>
